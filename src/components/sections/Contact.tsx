        ...
        <div className="bg-white border-4 border-black p-8 inline-block shadow-neo-lg max-w-2xl block rotate-0 sm:-rotate-1">
          ...
          {submitted ? (
            <div className="bg-neo-mint border-4 border-black p-6 text-center mb-6">
              <p className="font-black text-xl">✓ {tl({ en: 'Thanks for reaching out!', th: 'ขอบคุณที่ติดต่อมา!' })}</p>
              <p className="font-mono text-sm mt-2">{tl({ en: 'I\'ll get back to you soon.', th: 'ผมจะติดต่อกลับไปเร็วๆ นี้' })}</p>
            </div>
          ) : (
            <form onSubmit={handleSubmit} className="space-y-4 text-left mb-6">
              <div>
                ...
                <input
                  ...
                  required
                  placeholder={tl({ en: 'Your name', th: 'ชื่อของคุณ' })}
              ...
              <div>
                ...
                <textarea
                  ...
                  onChange={handleChange}
                  required
                  placeholder={tl({ en: 'Your message...', th: 'ข้อความของคุณ...' })}
                  rows={4}
