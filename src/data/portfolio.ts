  ...
  en: [
    ...
    },
    {
      ...
      items: [
        ...
        { name: "Nginx reverse proxy", level: "Hands-on" },
        { name: "systemd services", level: "Hands-on" },
        { name: "SSL / firewall / fail2ban", level: "Hands-on" },
  ...
  en: [
    {
      ...
      achievements: [
        "Deployed Hermes LINE AI Assistant behind Nginx with SSL, systemd, health checks, and hardened fallback routes",
  ...
  th: [
    {
      ...
      achievements: [
        "Deploy Hermes LINE AI Assistant หลัง Nginx พร้อม SSL, systemd, health checks และ fallback route ที่ harden แล้ว",
  ...
  en: [
    {
      ...
      highlights: [
        ...
        "Hardened public routes with SSL, firewall, fail2ban, and 403 fallbacks",
      ],
    },
    {
      id: 2,
      ...
      tech: ["Codex CLI", "Hermes API", "Bearer Auth", "PowerShell", "LINE Alerts"],
  ...
  th: [
    {
      ...
      highlights: [
        ...
        "Harden public routes ด้วย SSL, firewall, fail2ban และ 403 fallbacks",
      ],
    },
    {
      id: 2,
