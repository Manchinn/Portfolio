  ...
  en: [
    {
      ...
      longDescription: "Built a LINE-connected AI assistant with secure webhook routing, private service management, configurable model routing, service monitoring, deployment health checks, and locked-down public access patterns.",
    ...
    },
    {
      ...
      longDescription: "Built and operated a CS Logbook system for tracking student work and progress, including database-backed records, authentication workflows, dashboard views, and production deployment operations before the server was later cleaned and reused.",
  ...
  th: [
    {
      ...
      longDescription: "สร้าง AI assistant ที่เชื่อม LINE ผ่าน secure webhook routing, private service management, configurable model routing, service monitoring, deployment health checks และ public access pattern ที่ล็อกไว้",
      tech: ["Hermes", "LINE Messaging API", "Secure Routing", "Service Ops", "AI Gateway"],
      image: "https://placehold.co/600x400/111827/ffffff?text=Hermes+LINE+AI",
      date: "2026",
      category: "AI Assistant",
